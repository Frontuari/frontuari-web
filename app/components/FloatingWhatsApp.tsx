...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-50 bg-[#25D366] hover:bg-[#1ebe57] text-white p-3.5 sm:p-4 rounded-full shadow-lg hover:shadow-xl hover:shadow-[#25D366]/30 transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 flex items-center justify-center group"
